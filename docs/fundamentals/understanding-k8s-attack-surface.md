...
related:
  - /kubernetes-security/attack-vectors/intro/
...
For an in-depth overview of common attack techniques targeting Kubernetes clusters, explore the [Attack Vectors](/kubernetes-security/attack-vectors/intro) section. It highlights threats such as the following (and more):

- [Compromised API Server](/kubernetes-security/attack-vectors/compromised-api-server)
- [Exposed Kubernetes Dashboard](/kubernetes-security/attack-vectors/exposed-dashboard)
- [Insecure Secrets Management](/kubernetes-security/attack-vectors/insecure-secrets-management)
- [Lack of Network Policies](/kubernetes-security/attack-vectors/lack-of-network-policies)
- [Privileged Containers Escape](/kubernetes-security/attack-vectors/privileged-container-escape)

## **How to Reduce the Attack Surface?**

Comprehensive strategies for securing Kubernetes clusters are detailed in the [Best Practices](/kubernetes-security/best-practices/intro) section, which covers topics such as the following (and more):

- [Cluster Setup and Hardening](/kubernetes-security/best-practices/cluster-setup-and-hardening/intro)
- [Pod and Network Security](/kubernetes-security/best-practices/cluster-setup-and-hardening/network-security/network-policies)
- [Secure Secrets Management](/kubernetes-security/best-practices/cluster-setup-and-hardening/secrets-management/insecure-secrets-management-mitigation)
- [Monitoring and Runtime Security](/kubernetes-security/best-practices/monitoring-logging-and-runtime-security/intro)
