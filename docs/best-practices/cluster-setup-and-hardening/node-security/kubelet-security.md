...
This article provides an overview of kubelet security areas. For detailed authentication and authorization configuration, see [Securing Kubelet Authentication and Authorization](/kubernetes-security/best-practices/cluster-setup-and-hardening/node-security/kubelet-authentication/).
...
➡ [Securing Kubelet Authentication and Authorization](/kubernetes-security/best-practices/cluster-setup-and-hardening/node-security/kubelet-authentication/)
