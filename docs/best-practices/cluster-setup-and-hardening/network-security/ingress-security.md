...
> **⚠️ Important Notice:** Ingress NGINX is approaching **end-of-life** in **March 2026**. The Kubernetes SIG Network and Security Response Committee recommend migrating to **Gateway API** for long-term support and enhanced security features. See the [Gateway API Security](/kubernetes-security/best-practices/cluster-setup-and-hardening/network-security/gateway-api) guide for migration guidance.
...
For detailed migration guidance, see the [Gateway API Security](/kubernetes-security/best-practices/cluster-setup-and-hardening/network-security/gateway-api) article.
