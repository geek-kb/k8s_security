...
- **[Seccomp Profiles](/kubernetes-security/best-practices/cluster-setup-and-hardening/pod-security/seccomp-in-pods)** limit system calls at the kernel level.
- **[Pod Security Standards](/kubernetes-security/best-practices/cluster-setup-and-hardening/pod-security/pod-security-standards)** enforce security policies for workloads.
- **[RBAC and Least Privilege](/kubernetes-security/fundamentals/authorization/rbac)** ensure that workloads only have necessary permissions.
