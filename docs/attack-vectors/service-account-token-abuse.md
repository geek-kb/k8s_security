...
tags: [attack-vector, service-accounts, tokens, authentication, CKS]
related:
  - /kubernetes-security/best-practices/cluster-setup-and-hardening/rbac-and-identity/service-account-token-security/
...
[Service Account Token Security](/kubernetes-security/best-practices/cluster-setup-and-hardening/rbac-and-identity/service-account-token-security)
